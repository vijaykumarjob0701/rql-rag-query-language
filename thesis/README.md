...
| `03-related-work.tex` | draft | ACORN + VBASE + Filtered-DiskANN + Cormack RRF + **ColBERT** + **MUVERA** multimodally read |
...
| `06-optimizer.tex` | **HYPOTHESIS** | FilterExec modes + Search_late compile ladder (ColBERT→PLAID→MUVERA) |
| `07-compilation.tex` | **HYPOTHESIS** | Adapters / polystore shims |
| `08-applications.tex` | draft | Hybrid RRF + late-interact patterns grounded in Cormack/ColBERT/MUVERA |
