...
\begin{itemize}
  ...
  \item \textbf{Hybrid fuse (RRF / linear / LTR).}
    ...
    Choosing among \(\{rrf,linear,ltr\}\) is physical/policy \hypothesis{} (\S\ref{sec:fuse-preference}; Chen$\leftrightarrow$Bruch setup disagreement \established{}, journals 0016--0017).
