> **Pointer copy** of companion `rql-repro/datasets/REGISTRY.md` (synced 2026-09-17 Europe/Dublin). Prefer editing the companion registry; re-copy after digest updates. Binaries stay only under `rql-repro/datasets/cache/`.
